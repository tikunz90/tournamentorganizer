...
from .models.Tournament import Tournament, TournamentEvent, TournamentState, TournamentFinalRanking, TournamentTeamTransition, Court
from .models.Team import Team, TeamStats
from .models.Player import Player, PlayerStats
from .models.Game import Game, GameAction
from .models.Series import Series, Season, SeriesCup

admin.site.register(Tournament)
admin.site.register(TournamentEvent)
admin.site.register(TournamentCategory)
admin.site.register(SeriesCup)
