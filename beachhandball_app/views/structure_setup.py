...
from beachhandball_app.forms.structure_setup.forms import TTTUpdateForm, TournamentStageForm, TournamentStateForm, TournamentStateUpdateForm, TeamStatsUpdateTeamForm
